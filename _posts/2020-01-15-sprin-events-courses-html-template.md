---
title: Sprin Events & Courses HTML Template
cta:
  - title: Contact Support
    icon: lifesaver
    url: https://themeforest.net/item/sprin-courses-and-events-html5-responsive-template/25089640/support
  # - title: Learn Jekyll
  #   icon: album
  #   url: https://themeforest.net/item/sprin-courses-and-events-html5-responsive-template/25089640/support
...
`dist/index.html` - Courses page  
`dist/events.html` - Events page  
`dist/course.html` - Course page  
`dist/event.html` - Event page  
...
If you would like to edit the primary color of the theme you should do "Replace all" color `#6BE181` with the desired one.

## Support
Customer support is provided through our Envato item [support](https://themeforest.net/item/sprin-courses-and-events-html5-responsive-template/25089640/support) tab for up to six months from the purchase date and is provided Monday to Friday during the business week. We aim to answer all support requests daily, most are handled within 24h.
