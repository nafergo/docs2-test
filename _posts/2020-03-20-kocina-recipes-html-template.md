---
title: Kocina Recipes HTML Template
cta:
  - title: Contact Support
    icon: lifesaver
    url: https://themeforest.net/item/kocina-cooking-recipes-html5-responsive-template/25392984
  # - title: Learn Jekyll
  #   icon: album
  #   url: https://themeforest.net/item/kocina-cooking-recipes-html5-responsive-template/25392984
...
`dist/index.html` - Home recipes page  
`dist/recipe.html` - Recipe page  
...
If you would like to edit the primary color of the theme you should do "Replace all" color `#eb4a36` with the desired one.
